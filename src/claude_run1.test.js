...
describe('ClearCompletedButton', () => {
  ...
  describe('disabled state', () => {
    ...
    it('updates disabled state when hasCompleted prop changes from false to true', async () => {
      const wrapper = mount(ClearCompletedButton, {
        props: { hasCompleted: false }
      })
      const button = wrapper.find('[data-testid="ClearCompletedButton"]')
    ...
    it('updates disabled state when hasCompleted prop changes from true to false', async () => {
      const wrapper = mount(ClearCompletedButton, {
        props: { hasCompleted: true }
      })
      const button = wrapper.find('[data-testid="ClearCompletedButton"]')
  ...
  describe('click interactions', () => {
    ...
    it('emits clear event multiple times on multiple clicks when hasCompleted is true', async () => {
      const wrapper = mount(ClearCompletedButton, {
        props: { hasCompleted: true }
      })
      const button = wrapper.find('[data-testid="ClearCompletedButton"]')
  ...
  describe('reactivity', () => {
    it('starts emitting clear after hasCompleted changes to true', async () => {
      const wrapper = mount(ClearCompletedButton, {
        props: { hasCompleted: false }
      })
      const button = wrapper.find('[data-testid="ClearCompletedButton"]')
    ...
    it('stops emitting clear after hasCompleted changes to false', async () => {
      const wrapper = mount(ClearCompletedButton, {
        props: { hasCompleted: true }
      })
      const button = wrapper.find('[data-testid="ClearCompletedButton"]')
  ...
  describe('accessibility', () => {
    ...
    it('button element is a native button for proper accessibility', () => {
      const wrapper = mount(ClearCompletedButton)
      const button = wrapper.find('[data-testid="ClearCompletedButton"]')
