...
describe('ToggleAllCheckbox', () => {
  ...
  test('checkbox reflects allChecked prop when false', () => {
    const checkbox = wrapper.find('[data-testid="ToggleAllCheckbox"]');
    expect(checkbox.element.checked).toBe(false);
  });

  test('checkbox reflects allChecked prop when true', async () => {
  ...
  test('responds to change event on checkbox', async () => {
    const checkbox = wrapper.find('[data-testid="ToggleAllCheckbox"]');
